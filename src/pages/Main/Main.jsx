...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `고덕국제신도시 중심 입지`,
    text2: `평택 고덕국제신도시 프리미엄<br/>
            미래가치를 기대할 수 있는 핵심 입지`,
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `광역 교통 환경 프리미엄`,
    text2: `서정리역 생활권 및 주요 도로망 접근성<br/>
            편리한 이동 환경과 광역 교통 인프라`,
  ...
  },
  {
    ...
    title: "PREMIUM 04",
    text1: `쾌적한 주거 환경`,
    text2: `공원과 녹지 환경을 가까이 누리는 생활<br/>
            여유로운 고덕국제신도시 라이프`,
      ...
      {!isMobile ? (
        ...
        <div className={styles.imageContainer}>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  ...
                  - 브랜드 가치와 미래가치를 함께 누리는 주거 단지<br />
                  - 서정리역 생활권 및 광역 교통망 접근성 기대<br />
          ...
          <div className={styles.section}>
            <div className={styles.section2}>
              ...
              <img
                src={section2_Image1}
                alt="평택 고덕 수자인풍경채아파트 조감도-image3"
                loading="lazy"
                decoding="async"
              />
            </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="평택 고덕 수자인풍경채브랜드소개-image4"
                  loading="lazy"
                  decoding="async"
                />
                <div className={styles.text1}>평택 고덕 수자인풍경채</div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/mredqegy"
              method="POST"
            >
              <label htmlFor="name">
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="평택 고덕 수자인풍경채오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <img
            src={mobileImageMain}
            className={styles.mainImage}
            alt="평택 고덕 수자인풍경채 아파트 모바일 메인 이미지"
          />
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 평택 고덕 수자인풍경채에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="평택 고덕 수자인풍경채모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="평택 고덕 수자인풍경채브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="평택 고덕 수자인풍경채오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
