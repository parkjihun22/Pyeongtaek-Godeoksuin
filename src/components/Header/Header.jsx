      ...
      <>
        ...
        <div className={styles.mobileHeader}>
          <div onClick={() => setIsMobileMenu((v) => !v)}>
            {!isMobileMenu ? (
              <AiOutlineMenu className={styles.icon} size={25} color="#01496f" />
            ) : (
              <IoCloseSharp className={styles.icon} size={25} color="#01496f" />
            )}
          </div>
          {isMobileMenu && (
            <SlideMenu
          ...
          <a href="tel:1533-8848">
            <IoCall className={styles.icon} size={25} color="#01496f" />
          </a>
        </div>
        {isInterestPopupOpen && (
          <InterestPopup
